...
\cmidrule(r){3-4}\cmidrule(r){5-8} \multicolumn{1}{l}{} & \multicolumn{1}{l}{Variable} & \multicolumn{1}{l}{Count} & \multicolumn{1}{l}{Mean} & \multicolumn{1}{l}{Mean} & \multicolumn{1}{l}{SD} & \multicolumn{1}{l}{Min.} & \multicolumn{1}{l}{Max.}\\ 
 ...
 & Self-Identification - Museum & 179 & 0.373 &  0.408 &  0.49 & 0 & 1 \\ 
   ...
   & Exhibition Quantile &  &  &  0.428 &  0.24 & 0.083 & 1 \\ 
...
% latex table generated in R 4.3.3 by xtable 1.8-4 package
% Wed Apr  3 13:14:43 2024
\begin{table}[ht]
\centering
\begin{tabular}{p{0mm}lD{)}{)}{8)3}D{)}{)}{8)3}}
  \hline 
 \multicolumn{1}{l}{} & \multicolumn{1}{l}{Variable} & \multicolumn{1}{l}{r\_more} & \multicolumn{1}{l}{r\_waf}\\ 
 \hline
  \multicolumn{4}{l}{\textbf{Founder}} \\ 
 & Gender - Female & .19 \; (0.36) & .52 \; (0.47) \\ 
   & Gender - Couple & .08 \; (0.36) & .24 \; (0.44) \\ 
   & Founder died & .11 \; (0.53) & -.09 \; (0.69) \\ 
   \multicolumn{4}{l}{\textbf{Museum}} \\ 
 & Self-Identification - Foundation & .81 \; (0.48) & 1.01 \; (0.67) \\ 
   & Self-Identification - Collection & .45 \; (0.58) & .85 \; (0.73) \\ 
   & Self-Identification - Other & 1.29 \; (0.38)^{***} & 1.40 \; (0.56)^{*} \\ 
   & AN Ranking - Included & .38 \; (0.41) & .38 \; (0.51) \\ 
   & AN Ranking - Dropped & 1.15 \; (0.45)^{*} & 1.31 \; (0.62)^{*} \\ 
   & Founder name in Museum name & -.31 \; (0.33) & -.35 \; (0.41) \\ 
   & MOW inclusion & -.81 \; (0.40)^{*} & -.66 \; (0.51) \\ 
   & Exhibition Quantile &  & -.70 \; (0.82) \\ 
   \multicolumn{4}{l}{\textbf{Environment}} \\ 
 & PM density & -.05 \; (0.03) & -.02 \; (0.04) \\ 
   & PM density$^{2}$ & .00 \; (0.00) & .00 \; (0.00) \\ 
   & Pop. (millions) within 10km & .02 \; (0.11) & .10 \; (0.12) \\ 
   & Nbr PM within 10km & .11 \; (0.06)^{*} & .07 \; (0.09) \\ 
   \hline
 & Museum-years & 6903 & 3292 \\ 
   & Closures & 53 & 33 \\ 
   & log. Likelihood & -263.16 & -137.85 \\ 
   & AIC & 554.31 & 305.71 \\ 
   & BIC & 581.90 & 328.16 \\ 
   \hline 
