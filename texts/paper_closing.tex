...
\cmidrule(r){3-4}\cmidrule(r){5-8} \multicolumn{1}{l}{} & \multicolumn{1}{l}{Variable} & \multicolumn{1}{l}{Count} & \multicolumn{1}{l}{Mean} & \multicolumn{1}{l}{Mean} & \multicolumn{1}{l}{SD} & \multicolumn{1}{l}{Min.} & \multicolumn{1}{l}{Max.}\\ 
 ...
 & Gender - Male & 294 & 0.584 & 6.0e-01 &  0.49 & 0 & 1 \\ 
   ...
   & Founder - died recently &  &  & 1.3e-02 &  0.11 & 0 & 1 \\ 
   & Founder - died 2+ years ago &  &  & 8.4e-02 &  0.28 & 0 & 1 \\ 
   & Founder died &  &  & 9.7e-02 &  0.30 & 0 & 1 \\ 
...
While the coefficient in the short-term period is consistently higher than both the overall death coefficient and the long-term period coefficients, so far the evidence is inconclusive as only few cases are statistically significant\footnote{P-values are not adjusted for multiple tests}.
Considering the underlying numbers supports this:
While 47 private museums have seen the death of their founders, only 3 of these have closed in the following 5 years; observing statistical significance in some configurations of founder death time more likely reflect random clustering than an underlying pattern.
\textbf{Effect sizes}:
\begin{itemize}
\item death overall
\item short-term death
\end{itemize}
