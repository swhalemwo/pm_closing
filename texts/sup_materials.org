...
These while it would be possible for these different specifications to lead to similar interpretations, in practice they diverge substantially.
#
Using Private museum density (ref), the general conclusion would be that competition increases mortality as predicted closing chance is highest in areas of low population and large private museum populations.
#
However, using audience leads to the opposite conclusion, as higher audience is associated with higher mortality; predicted closing chance is highest for areas of low numbers of private museums and large populations.
#
It is beyond the scope of the paper to explore the origin of these diverging perspectives in detail.
#
