...
#
A small number of museums are excluded:
# 
Three museums for which the closing date could not be found, {{{pm_open_from2021}}} which opened in 2021 and later (as survival analyses requires positive survival times), as well as two which closed before 2000 as they fall outside the period under investigation.
#
...
Overall the entire life span, the average hazard rate is {{{meanhaz_upto_100}}} {{{yearhaz_all}}}, which allows comparison to other studies of NPO closure.
#
...
#
None of these focus specifically on museums ([[textcite:&Hager_2001_vulnerability]] focuses on Art NPOs, [[textcite:&Bowen_1994_charitable]] and [[cite:&Gordon_etal_2013_insolvency]] on non-profits generally), but report survival estimates by organizational form, including museums.
#
[[textcite:&Bowen_1994_charitable]] reports average annual exit rates for the 1981-1991 time period of 1.1% (p.103)
#
[[cite:&Bowen_1994_charitable]] presumably base their sample on all active 501(c)(3) organizations (rather than only institutions with revenues exceeding 25,000 USD).
#
...
#
Some of this difference may be explained by higher shares of smaller organizations in [[textcite:&Bowen_1994_charitable]], where NPOs of any size are included, whereas [[textcite:&Gordon_etal_2013_insolvency]] excluded NPOs wiht operational revenues below 150,000 USD by, as smaller non-profits are at higher risk of closing [[parencite:&Harrison_Laincz_2008_nonprofit;&Helmig_Ingerfurth_Pinz_2013_nonprofit]].
#
Focusing directly on Art museums, rather than museumm generally, [[textcite:&Hager_2001_vulnerability]] observes 42 closures over a period of 4 years from a starting populaton of 448 (p.383).
#
As his way of delineating the population (having "filed an annual Form 990 tax return with the IRS for the 1990, 1991, or 1992 tax year", p.380) does not rule out that some closings took place in 1991 or 1992, attributing some closings to these years is likely appropriate, and roughly equivalent to assuming an observation period of five (rather than four) years, which results (assuming a constant hazard) in an average closing rate of $1-\sqrt[5]{406/448}$ = 1.9%.



So far it is hard to tell why art museums appear to have higher closing rates than museums generally.
#
According to [[textcite:&IMLS_2008_funding]], art museums have above-average reliance on earned income (46.1% compared to 43.7% on average, p.26), and [[textcite:&Bowen_1994_charitable]] argue that a higher reliance on income is associated with exit rates (p.102), but it is questionable whether such an a small difference in percent earned can explain a 1.7-2.7 higher closing risk.
#
...
#
Neither focuses on age-based hazard rate, but as the average number of exits in a calendar year.


#+caption: Hazard rates in studies of museums and art NPOs
#+label: tbl:litreview
|-----------------------------------+--------------+-------------+-----------------------+-------------|
| study                             | population   | measurement | calculation           | time period |
|-----------------------------------+--------------+-------------+-----------------------+-------------|
| [[cite:&Hager_2001_vulnerability]]    | Art Museums  |        2.4% |                       |   1994-1997 |
| [[cite:&Gordon_etal_2013_insolvency]] | Museums      |        0.7% | Closings/museum years |   2000-2003 |
