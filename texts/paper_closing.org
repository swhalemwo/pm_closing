...
#
Studies primarily focus on the effect of reputation on some tangible benefits such as donations and contributions [[parencite:&Sarstedt_2010_reputation;&Mews_Boenigk_2012_blood;&Heller_2008_alliances;&Meijer_2009_reputation]], or its direct effect on survial [[parencite:&Lu_Shon_Zhang_2019_dissolution;&Singh_1991_change;&Hager_2001_vulnerability;&Bielefeld_1994_survival;&HernandezOrtiz_2022_discontinuity]][fn:: Furthermore, the term "survival" is sometimes used more loosely to refer to a non-profit's effective operation and financial condition rather than the more narrowly defined dissolution (e.g. [[cite:&Santos_Laureano_Moro_2019_reputation p.58]], [[cite:&Heller_2008_alliances p.15]], [[cite:&Schloderer_Sarstedt_Ringle_2014_reputation p.111]])], with most studies finding support for a positive effect of reputation.
#
...
#
As has also been summarized in the previous section, an identity that is legitimate (understandable) and favorable (positive) has been argued to have a vast number of positive outcomes for organizations such as allowing higher profits, satisfaction, as well as weaker impact of shocks, and providing the opportunity to deviate from established patterns  [[parencite:&Lange_Lee_Dai_2010_reputation]], which in turn can facilitate survival prospects [[parencite:&Rao_1994_reputation]].
#
...
#
Next to material organizational features, adherence to naming conventions has been found to enhance perceptions of legitimacy; organizations that adhere to field norms about name length, name ambiguity (usage of artificial names) and name domain specificity (mentioning industry) were judged more legitimate parencite:&Glynn_Abzug_2002_names.


*something about frameworks reflecting * 

One reason why names might not reflect 



An association of names with survival might reflect an effect of institutional characteristics, but only if names and characteristics are strongly linked. 
# 
However, the category of museums is rather loosely regulated: 
#
The term "museum" is generally not subject to state regulation in the US [[cite:&Moore_2022_best p.205]] or European countries such as Germany [[parencite:&Museumsbund_ICOMDE_2006_standards p.4]], Denmark, Austria, Croatia or Finland [[parencite:&EGMUS_2024_reports]][fn::Which is not to say that in other countries it necessarily is a protected term. While I was not able to find information on the naming regulations of museums for every country, I did not find any country where such naming regulation is present.].
#
...
#
ICOM has around 3,000 institutional members [[parencite:&ICOM_2020_report19]], a relatively small fraction of the over 104,000 museums estimated to exist globally [[parencite:&UNESCO_2021_covid]]. [fn::The absence of clear criteria what constitutes a museum prevents standardized data collection which would be necessary to generate exact numbers.], and while national associations fare somewhat better, with e.g. the American Association of Museums representing over 4,000 of the country's 35,000 museums [[parencite:&LOC_2019_AAM]], and the German Museumsbund representing over 1,300 [[parencite:&Museumsbund_2024_mitgliedmuseen]] of Germany's 7,120 museums [[parencite:&IMF_2024_museumsstatistik]], the ability of these associations to impose standards is still limited.
#
In such an unregulated field, names do not clearly reflect institutional characteristics, which leaves evaluation of an institution to more ad-hoc, practical classification systems [[parencite:&van_Venrooij_2018_fuzziness]].
#
