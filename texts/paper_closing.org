...
While the central role of the founder has been argued to constitute a risk factor, I find no conclusive relationship between mortality and a number of founder characteristics, such as founder gender, death, exclusion from the Artnews collector ranking or inclusion of founder name in the museum name.
# 
...
voluntary yes, but seems to be exception (both when inferred via naming pattern, and closing reasons)
non-voluntary closing as high as other NPOs
