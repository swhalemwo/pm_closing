...
#+MACRO: ynkplt_p_pred_heatmap_comp1 (eval (concat "#+label: fig:p_pred_heatmap_comp1\n" "#+caption: kappa\n" "#+attr_latex: :width 18cm\n" "[[file:../figures/p_pred_heatmap_comp1.pdf]]"))
...
#+MACRO: refplt_p_pred_heatmap_comp1 \ref{fig:p_pred_heatmap_comp1}
