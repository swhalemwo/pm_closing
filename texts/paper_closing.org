...
#
German museums in the 1990s covered on average only around 30% of their budget by their income [[parencite:&Martin_1993_museen]][fn::Own calculations based on table p.233], with private museums however requiring less support as operations provide around 47% of their budget (ibid.), and even the more market-oriented NPOs in the cultural sector draw around 50% of their funding from public support [[parencite:&Zimmer_Priller_2007_gemeinnuetzig p.82]].
#
...
#
[[textcite:&StylianouLambert_etal_2014_museums]] also characterize many private institutions as "small individual museums that depend too much on their creators to guarantee their sustainability" (p.582).
#
...
Focusing directly on Art museums (NTEE code A51), rather than museum generally as part of a wider focus on Art NPOs, [[textcite:&Hager_2001_vulnerability]] observes 42 closures over a period of 4 years (1994-1997) from a starting populaton of 448 (p.383).
#
