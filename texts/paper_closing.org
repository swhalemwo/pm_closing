...
*Hypothesis 2*: Reliance on the founder is the mechanism through which PMs are exposed to higher closing risk, thus founder-related variables can be used to predict closing. 
...
- *Hypothesis 2b*: Private museums are more likely to clos after their founder is excluded from a prestigious ranking.
