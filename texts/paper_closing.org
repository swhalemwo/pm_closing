...
* The closure of private museums: Legitimacy, status, density
...
Legitimacy is also measured by inclusion in industry registers, such as the Museum of the World (MOW) database [[parencite:&deGruyter_2021_MOW]].
